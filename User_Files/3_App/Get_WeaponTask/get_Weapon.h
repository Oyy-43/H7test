...
typedef enum FSM_GetWeapon_Event
{
    ...
    GetWeapon_Event_HeadDetect,             //检测到端头，进入Process2
    GetWeapon_Event_ClampDone,              //夹紧完成，进入Process3
    GetWeapon_Height_upDone,                //抬高完成，进入Process4
    GetWeapon_Event_LiftDone,               //抬起完成，进入Process4
